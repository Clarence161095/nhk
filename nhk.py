...
def parse(o):
    try:
        ...
        with open('nhk-easy.html', "w") as f:
            ...
            print('<style type="text/css">body { margin-left: 1em;  margin-right: 1em;  font-family: "Courier New", Courier, monospace;  line-break: normal;  -epub-line-break: normal;  -webkit-line-break: normal;}p {  text-indent: 1em;}h1 {  font-size: 1.2rem;  font-weight: bold;}rt {  font-size: 0rem;  font-weight: normal;  color: rgba(0, 0, 0, 0);}img {  display: none;}</style>', file=f)
            print("</head>", file=f)
            print("<body>", file=f)
        ...
        with open('nhk-easy-vertical.html', "w") as f:
            ...
            print(
                '<head><meta http-equiv="content-type" content="application/xhtml+xml; charset=UTF-8" >', file=f)
            print('<style type="text/css">body {  margin-left: 1em;  margin-right: 1em;  font-family: "Courier New", Courier, monospace;  writing-mode: tb-rl;  -epub-writing-mode: vertical-rl;  -webkit-writing-mode: vertical-rl;  line-break: normal;  -epub-line-break: normal;  -webkit-line-break: normal;}p {  text-indent: 1em;}h1 {  font-size: 1.2rem;  font-weight: bold;}rt {  font-size: 0rem;  font-weight: normal;  color: rgba(0, 0, 0, 0);}img {  display: none;}</style>', file=f)
            print("</head>", file=f)
            print("<body>", file=f)
            for content in contents:
                print("<br />".join(content), file=f)
