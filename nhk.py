...
def parse(o):
    try:
        ...
        with open('nhk-easy.html', "w") as f:
            ...
            print('<style type="text/css">body {  margin-left: 1em;  margin-right: 1em;  font-family: serif;  line-break: normal;  -epub-line-break: normal;  -webkit-line-break: normal;}p {  text-indent: 1em;}h2 {  font-size: 0.5rem;  font-weight: bold;}rt {  font-size: 0.4rem;  font-weight: normal;  color: rgba(0, 0, 0, 0.4);}img {  display: none;}</style>', file=f)
            print("</head>", file=f)
            print("<body>", file=f)
