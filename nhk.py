...
def parse(o):
    try:
        ...
        with open('nhk-easy.html', "w") as f:
            ...
            print('<style type="text/css">body {  margin-left: 1em;  margin-right: 1em;  font-family: serif;  line-break: normal;  -epub-line-break: normal;  -webkit-line-break: normal;}p {  text-indent: 1em;}h1 {  font-size: 1.2rem;  font-weight: bold;}rt {  font-size: 0rem;  font-weight: normal;  color: rgba(0, 0, 0, 0);}img {  display: none;}</style>', file=f)
            print("</head>", file=f)
            print("<body>", file=f)
